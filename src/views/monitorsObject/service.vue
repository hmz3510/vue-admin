  ...
  <div class="app-container">
    ...
    <div class="app-mian">
      <div class="app-search">
        ...
        <div class="demo-input-suffix">
          <span>监控参数：</span>
          <el-select v-model="listQuery.watchNumber" placeholder="请选择" style="width: 240px;min-width: 240px;">
            <el-option
              v-for="item in watchNumberList"
              :key="item.id"
              :label="item.label"
              :value="item.id"
            />
    ...
    <div class="myTable">
      ...
      >
        ...
        <el-table-column prop="timeCycle" label="监控参数" width="180px" />
...
export default {
  ...
  methods: {
    ...
    editInfo(row) {
      this.$router.push({ name: 'newServer', params: row })
    },
    delInfo(row) {},
    addNewObj() {
      this.$router.push({ name: 'newServer', params: '' })
    }
  }
}
</script>
